...
Example:
  qip dry run text/markdown/commonmark.0.31.2.wasm text/html/html-page-wrap.wasm
...
Example:
  qip comply text/utf8-must-be-valid.wasm \
...
func parseRunCommandArgs(args []string, commandName string) (runCommandConfig, error) {
	...
	fs.Var(&config.formValues, "F", "multipart form field <name=value>, <name=@path>, or <name=<path>")
	fs.Var(&config.formValues, "form", "multipart form field <name=value>, <name=@path>, or <name=<path>")
...
func benchCmd(args []string) {
	...
	fs.Var(&formValues, "F", "multipart form field <name=value>, <name=@path>, or <name=<path>")
	fs.Var(&formValues, "form", "multipart form field <name=value>, <name=@path>, or <name=<path>")
